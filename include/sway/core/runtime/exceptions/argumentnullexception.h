#ifndef _SWAY_CORE_RUNTIME_EXCEPTIONS_ARGUMENTNULLEXCEPTION_H
#define _SWAY_CORE_RUNTIME_EXCEPTIONS_ARGUMENTNULLEXCEPTION_H
...
#endif // _SWAY_CORE_RUNTIME_EXCEPTIONS_ARGUMENTNULLEXCEPTION_H
