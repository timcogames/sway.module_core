...
TEST(VersionTest, ctor_comps) {
  ...
  const Version version(major, minor, patch, "tmp");
...
TEST(VersionTest, equality_operator) {
  ...
  ASSERT_TRUE(version == Version(1, 2, 3));
}
...
TEST(VersionTest, non_equality_operator) {
  ...
  ASSERT_NE(version, Version(1));
  ASSERT_NE(version, Version(1, 2));
}
...
TEST(VersionTest, comparison_operation) {
  const Version version(5, 2, 3);

  ASSERT_GE(version, Version(4));
  ASSERT_GE(version, Version(5, 1));
  ASSERT_GE(version, Version(4, 2));
  ASSERT_GE(version, Version(5, 2, 2));
  ASSERT_GE(version, Version(5, 1, 3));
  ASSERT_GE(version, Version(4, 2, 3));

  ASSERT_LE(version, Version(6));
  ASSERT_LE(version, Version(5, 3));
  ASSERT_LE(version, Version(6, 2));
  ASSERT_LE(version, Version(5, 2, 4));
  ASSERT_LE(version, Version(5, 3, 3));
  ASSERT_LE(version, Version(6, 2, 3));
}
