...
template <class TYPE>
auto SubsystemManager::getSubsystem(const std::string &classname) const
    -> SubsystemTypedefs::OptionalSharedPtr_t<TYPE> {
...
template <class TYPE>
auto SubsystemManager::getSubsystem() const -> SubsystemTypedefs::OptionalSharedPtr_t<TYPE> {
