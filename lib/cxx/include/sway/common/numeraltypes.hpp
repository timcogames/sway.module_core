#ifndef SWAY_COMMON_NUMERALTYPES_HPP
#define SWAY_COMMON_NUMERALTYPES_HPP
...
using iptr_t = intptr_t;  //!< Integer type for pointers
using uptr_t = uintptr_t;  //!< Integer (unsigned) type for pointers

}  // namespace sway

#endif  // SWAY_COMMON_NUMERALTYPES_HPP
