...
#define DECLARE_EVENT(EventId, EventName)                                                                       \
  ...
  public:                                                                                                       \
    ...
    MTHD_OVERRIDE(std::map<std::string, std::shared_ptr<sway::core::ValueData>> dataset()) { return dataset_; } \
                                                                                                                \
  private:                                                                                                      \
    std::string id_;                                                                                            \
    u32_t type_;                                                                                                \
    void *data_;                                                                                                \
    std::map<std::string, std::shared_ptr<sway::core::ValueData>> dataset_;                                     \
  };
