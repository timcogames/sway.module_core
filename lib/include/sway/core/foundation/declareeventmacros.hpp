...
#define DECLARE_EVENT(EventId, EventName)                                               \
  ...
  public:                                                                               \
    ...
    EventName##Event(u32_t type, sway::core::foundation::EventDataType data)            \
    ...
    MTHD_OVERRIDE(sway::core::foundation::EventDataType data() const) { return data_; } \
                                                                                        \
  private:                                                                              \
    std::string id_;                                                                    \
    u32_t type_;                                                                        \
    sway::core::foundation::EventDataType data_;                                        \
  };
